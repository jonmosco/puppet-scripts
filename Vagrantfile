...
Vagrant.configure('2') do |config|
  ...
  config.vm.define 'node1_el5' do |node1|
  ...
  config.vm.define 'node2_el6' do |node1|
    ...
    node1.vm.network :private_network, ip: "192.168.34.11"
  end
  ...
  config.vm.define 'node3_el7' do |node2|
    ...
    node2.vm.network :private_network, ip: "192.168.34.12"
  end
  ...
  config.vm.define 'node4_wheezy' do |node3|
    ...
    node3.vm.network :private_network, ip: "192.168.34.13"
  end
  ...
  config.vm.define 'node5_jessie' do |node4|
    ...
    node4.vm.network :private_network, ip: "192.168.34.14"
  end
  ...
  config.vm.define 'node7_xenial' do |node6|
    ...
    node6.vm.network :private_network, ip: "192.168.34.16"
  end
